...
contract EthPump {
 ...
 //存储所有贴纸(分类)信息
 mapping(string => mapping(uint => Goods))  goodsData;
 ...
 //添加物品
 function addGoods(string memory stickName, uint ethPledge, bool available) public returns(uint){
  //贴纸(分类)必须存在 
 ...
 //判断物品是否存在
 function isGoodExist(string memory stickName, uint inx) public view returns(bool){
   //贴纸(分类)必须存在 
   require(isStickExist(stickName), 
		 "stick not exist");
 ...
 //设置物品上下架
 function setGoodsStatus(string memory stickName, uint inx, bool available) public { 
   //物品必须存在 
 ...
 //查询物品是否上下架
 function isGoodsAvailable(string  memory stickName, uint inx) public view returns(bool) { 
   //物品必须存在 
   require(isGoodExist(stickName, inx), 
		 "goods not exist");
 ...
 //查询物品借出状态
 function isGoodsLend(string  memory stickName, uint inx) public view returns(bool) { 
   //物品必须存在 
   require(isGoodExist(stickName, inx), 
		 "goods not exist");
 ...
 //借出物品
 function borrowGoods(string memory stickName, uint inx) public payable { 
   //物品必须存在 
   require(isGoodExist(stickName, inx), 
		 "goods not exist");
 ...
 //查询物品借出人
 function queryBorrower(string memory stickName, uint inx) public view returns(address) { 
   //物品必须存在 
   require(isGoodExist(stickName, inx), 
		 "goods not exist");
 ...
 //设置物品已归还
 function doGoodsReturn(string memory stickName, uint inx) public { 
   //物品必须存在 
   require(isGoodExist(stickName, inx), 
		 "goods not exist");
